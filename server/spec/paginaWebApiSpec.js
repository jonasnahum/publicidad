describe("paginasweb api", function() {
    ...
    //var usuarioApi = new UsuarioApi({paginaWeb: modelMock, usuario: usuarioMock}, usuarioFactory);
    ...
    it("with a given req.body and page id params, updates a page", function(done) {
        //var api = new PaginaWebApi({paginaWeb: modelMock, usuario: usuarioMock}, modelFactory, copy);
        //var api = new PaginaWebApi({paginaWeb: modelMock, usuario: modelMock2}, modelFactory, copy);//se sobreescripe api para que use usuarioMock y no modelMOck2.
