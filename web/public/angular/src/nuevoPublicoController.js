(function() {
    ...
    arrDep = ['$routeParams','$location', 'mapFactory', 'productosFactory', 'paginasProxy', 'tokenStorage']; 
    arrDep.push(function($route, $location, mapFactory, productosFactory, paginasProxy, tokenStorage) {
