(function() {
    ...
    app.controller('EditarFormularioController', ['Upload', '$timeout', '$http', '$routeParams', '$location', 'productosManager', function(Upload, $timeout, $http, $route, $location, productosManager) {
        var ctrl = this;
